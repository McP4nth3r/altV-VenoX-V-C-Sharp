...
namespace VenoXV.Reallife.advertise
{
    public class Werbung : IScript
    {
                ...
                if (ADS_ACTIVATED)
                {
                    if (WERBUNG_COOLDOWN <= DateTime.Now)
                    {
                        ...
                        if (player.vnxGetElementData<int>(EntityData.PLAYER_MONEY) > FINAL_AD_COSTS)
                        {
                            ...
                            player.vnxSetSharedElementData<object>( EntityData.PLAYER_MONEY, player.vnxGetElementData<int>(EntityData.PLAYER_MONEY) - FINAL_AD_COSTS);
        ...
        public static void CreateWerbung(IPlayer player, string text)
        {
