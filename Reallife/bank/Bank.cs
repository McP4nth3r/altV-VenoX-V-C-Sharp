            ...
            try
            {
                ...
                if (button == "einzahlen")
                {
                    if (value != 0)
                    {
                        ...
                        {
                            player.vnxSetSharedElementData<object>(Core.VnX.PLAYER_BANKMONEY, player.vnxGetElementData<int>(EntityData.PLAYER_BANK) + value);
                            player.vnxSetSharedElementData<object>(Core.VnX.PLAYER_MONEY, player.vnxGetElementData<int>(EntityData.PLAYER_MONEY) - value);
                ...
                else
                {
                    ...
                    if (charakterexestiert)
                    {
                        ...
                        else
                        {
                            ...
                            player.vnxSetSharedElementData<object>(Core.VnX.PLAYER_BANKMONEY, player.vnxGetElementData<int>(EntityData.PLAYER_BANK) - value);
                            target.vnxSetSharedElementData<object>(Core.VnX.PLAYER_BANKMONEY, target.vnxGetElementData<int>(EntityData.PLAYER_BANK) + value);
