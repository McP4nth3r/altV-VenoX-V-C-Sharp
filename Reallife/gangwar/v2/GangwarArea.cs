    ...
    public class GangwarArea
    {
        ...
        public void CreateArea()
        {
            try
            {
                ...
                //ToDo: ClientSide erstellen NAPI.TextLabel.CreateTextLabel("TK", new Position(this.TK.X, this.TK.Y, this.TK.Z + 0.13), 20.0f, 2f, 4, new Rgba(0, 150, 200));
        ...
        public void CreateIVehicles()
        {
            ...
            {/*
                ...
                foreach (var veh in this.IVehicles)
                {
                    ...
                    Core.VnX.IVehiclevnxSetSharedData(veh, "kms", 0);
                    Core.VnX.IVehiclevnxSetSharedData(veh, "gas", 100);
