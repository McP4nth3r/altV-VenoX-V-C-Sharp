    ...
    public class Motorrad_Führerschein : IScript
    {
        ...
        public static void Start_Motorrad_Führerschein(IPlayer player)
        {
            try
            {
                ...
                player.vnxSetElementData<object>("PRUEFUNGS_NAME", "BIKE");
               ...
               dxLibary.VnX.DrawZielBlip(player, "Checkpoint [ Führerschein ]", Pruefungs_Marker_Motorrad[1], 611, 3, player.Dimension);
                ...
                Motorrad_Führerschein_Abgabe_Marker.vnxSetElementData<object>("Name",player.GetVnXName<string>());
            }
            catch
            {
            }
        ...
        public static void TriggerToNextPruefungsMarker(IPlayer player, int counter)
        {
            try
            {
                if (counter == 31)
                {
                    ...
                    player.vnxSetElementData<object>(EntityData.PLAYER_MOTORRAD_FÜHRERSCHEIN, 1);
                    player.vnxSetSharedElementData<object>( EntityData.PLAYER_MONEY, player.vnxGetElementData<int>(EntityData.PLAYER_MONEY) - 8750);
