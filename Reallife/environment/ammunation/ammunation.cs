                ...
                if (item == "Pistolen Magazin")
                {
                    ...
                    if (Pistole != null)
                    {
                        if (playermoney >= 90)
                        {
                            ...
                            player.SendChatMessage("!{255,255,255}Du hast ein !{0,200,255}Pistolen Magazin !{255,255,255}gekauft!");
                        }
                        else
                        {
                    ...
                    {
                        player.SendChatMessage( "!{200,0,0}Kauf dir erst eine Pistole!");
                    }
                }
                else if (item == "Pistole 50 Magazin")
                {
                    ...
                    if (Pistole50 != null)
                    {
                        if (playermoney >= 165)
                        {
                            ...
                            player.SendChatMessage("!{255,255,255}Du hast ein !{0,200,255}Pistolen 50. Magazin !{255,255,255}gekauft!");
                        }
                        else
                        {
                            player.SendChatMessage("!{200,0,0}Du hast nicht genug Geld!");
                ...
                else if (item == "Revolver Magazin")
                {
                    ...
                    if (Revolver != null)
                    {
                        if (playermoney >= 220)
                        {
                            ...
                            player.SendChatMessage("!{255,255,255}Du hast ein !{0,200,255}Revolver Magazin !{255,255,255}gekauft!");
                        }
                        else
                        {
                            player.SendChatMessage("!{200,0,0}Du hast nicht genug Geld!");
                ...
                else if (item == "Shotgun Magazin")
                {
                    ...
                    if (Shotgun != null)
                    {
                        if (playermoney >= 100)
                        {
                            ...
                            player.SendChatMessage("!{255,255,255}Du hast ein paar !{0,200,255}Schrotkugeln !{255,255,255}gekauft!");
                ...
                else if (item == "PDW Magazin")
                {
                    ...
                    if (PDW != null)
                    {
                        if (playermoney >= 450)
                        {
                            ...
                            player.SendChatMessage("!{255,255,255}Du hast ein !{0,200,255}PDW Magazin !{255,255,255}gekauft!");
                ...
                else if (item == "Rifle Magazin")
                {
                    ...
                    if (Rifle != null)
                    {
                        if (playermoney >= 535)
                        {
                            ...
                            player.SendChatMessage("!{255,255,255}Du hast ein !{0,200,255}Rifle Magazin !{255,255,255}gekauft!");
            ...
            try
            {
                ...
                if (item == "Weste")
                {
                    if (playermoney >= 100)
                    {
                        ...
                        {
                            player.SendChatMessage("!{255,255,255}Du hast bereits eine !{0,200,255}" + item);
                        }
                    }
                    else
                    {
                ...
                else if (item == "Messer")
                {
                    ...
                    if (SWITCHBLADE == null) // WEED
                    {
                        if (playermoney >= 200)
                        {
                            ...
                            player.SendChatMessage("!{255,255,255}Du hast ein !{0,200,255}" + item + " !{255,255,255}gekauft!");
                        }
                        else
                        {
                            player.SendChatMessage("!{200,0,0}Du hast nicht genug Geld!");
                    ...
                    {
                        player.SendChatMessage("!{200,0,0}Du hast bereits ein Messer!");
                    }
                }
                else if (item == "Fallschirm")
                {
                    ...
                    if (FALLSCHIRM == null) // WEED
                    {
                        if (playermoney >= 925)
                        {
                            ...
                            player.SendChatMessage("!{255,255,255}Du hast einen !{0,200,255}" + item + " !{255,255,255}gekauft!");
                        }
                        else
                        {
                            player.SendChatMessage("!{200,0,0}Du hast nicht genug Geld!");
                    ...
                    {
                        player.SendChatMessage("!{200,0,0}Du hast bereits einen Fallschirm!");
                    }
                }
                else if (item == "Pistole")
                {
                    ...
                    {
                        player.SendChatMessage("!{200,0,0}Du hast bereits eine Pistole!");
                    }
                }
                else if (item == "Pistole50")
                {
                    ...
                    {
                        player.SendChatMessage("!{200,0,0}Du hast bereits eine Pistole 50 !");
                    }
                }
                else if (item == "Revolver")
                {
                    ...
                    {
                        player.SendChatMessage("!{200,0,0}Du hast bereits eine Revolver!");
                    }
                }
                else if (item == "Shotgun")
                {
                    ...
                    {
                        player.SendChatMessage("!{200,0,0}Du hast bereits eine Shotgun!");
                    }
                }
                else if (item == "PDW")
                {
                    ...
                    {
                        player.SendChatMessage("!{200,0,0}Du hast bereits eine PDW!");
                    }
                }
                else if (item == "Rifle")
                {
                    ...
                    {
                        anzeigen.Usefull.VnX.UpdateQuestLVL(player, anzeigen.Usefull.VnX.QUEST_GETADVANCEDRIFLE);
                        player.SendChatMessage("!{200,0,0}Du hast bereits ein Gewehr!");
                    }
                }
                else
                {
