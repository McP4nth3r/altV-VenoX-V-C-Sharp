! function(e) {
	...
	var drug_font = new FontFace('drug_font', './font/Caviar-Dreams.ttf', { style: 'normal', weight: 700 });
    var ge = {
        renderTo: null,
        width: 0,
        height: 0,
        ...
        colorUnits: "#888",
        colorNumbers: "#444",
        colorNeedle: "rgba(0,200,255,1)",
        colorNeedleEnd: "rgba(0,105,145,.9)",
        colorValueText: "#fff",
        ...
        colorValueBoxRect: "#006496",
        colorValueBoxRectEnd: "#004b64",
        colorValueBoxBackground: "#00394c",
