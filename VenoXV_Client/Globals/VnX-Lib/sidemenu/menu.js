...
function populateTunningComponents() {
	if(messagesLoaded) {
		...
		for(let i = 0; i < tunningComponents[selected].components.length; i++) {
			...
			{itemDescription.textContent =  "Straßen Getriebe";costs = 5500;}			
		
			else if(component.desc == "Getriebe - 2")
			{itemDescription.textContent =  "Sport Getriebe";costs = 11000;}
		
			else if(component.desc == "Getriebe - 3")
			{itemDescription.textContent =  "Renn Getriebe";costs = 16500;}
		
			else if(component.desc == "Motor [ EMS ] - 1")
			{itemDescription.textContent =  "EMS Verbesserung I [15% Mehr Leistung]";costs = 5500;}			
		
			else if(component.desc == "Motor [ EMS ] - 2")
			{itemDescription.textContent =  "EMS Verbesserung II [25% Mehr Leistung]";costs = 11000;}
		
			else if(component.desc == "Motor [ EMS ] - 3")
			{itemDescription.textContent =  "EMS Verbesserung III [35% Mehr Leistung]";costs = 16500;}
		
			else if(component.desc == "Bremsen - 1")
			{itemDescription.textContent =  "Bremsen Verbesserung I [15% Mehr Bremskraft]";costs = 5500;}			
		
			else if(component.desc == "Bremsen - 2")
			{itemDescription.textContent =  "Bremsen Verbesserung II [25% Mehr Bremskraft]";costs = 11000;}
		
			else if(component.desc == "Bremsen - 3")
			{itemDescription.textContent =  "Bremsen Verbesserung III [35% Mehr Bremskraft]";costs = 16500;}
		
			else if(component.desc == "Tieferlegung - 1")
			{itemDescription.textContent =  "Tieferlegung Stufe I";costs = 5500;}			
		
			else if(component.desc == "Tieferlegung - 2")
			{itemDescription.textContent =  "Tieferlegung Stufe II";costs = 11000;}
		
			else if(component.desc == "Tieferlegung - 3")
			{itemDescription.textContent =  "Tieferlegung Stufe III";costs = 16500;}
			else if(component.desc == "Tieferlegung - 4")
			{itemDescription.textContent =  "Tieferlegung Stufe IIII";costs = 16500;}
			else if(component.desc == "Turbolader - 1")
			{itemDescription.textContent =  "Turbolader [35% Mehr Beschleunigung]";costs = 15000;}
		...
		purchaseButton.onclick = (function() {
			if(drawable != undefined) {
				mp.trigger('Purchase_Tuning_C',  tunningComponents[selected].slot, drawable);
			}
		});

		cancelButton.onclick = (function() {
			mp.trigger('Reload_Tuning_C');
