    ...
    public class WT : IScript
    {
        ...
        public static void Start_WT_Server(PlayerModel player, int baseball, int pistol, int pistol_ammo, int pistol50, int pistol50_ammo, int revolver, int revolver_ammo, int mp5, int mp5_ammo, int ak47, int ak47_ammo, int rifle, int rifle_ammo, int sniperrifle, int sniperrifle_ammo, int rpg, int rpg_ammo, int molotov, int totalcost)
        {
            try
            {
                ...
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_PISTOL_AMMO, pistol_ammo_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_PISTOL50, pistol50_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_PISTOL50_AMMO, pistol50_ammo_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_REVOLVER, revolver_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_REVOLVER_AMMO, revolver_ammo_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_MP5, mp5_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_MP5_AMMO, mp5_ammo_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_AK47, ak47_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_AK47_AMMO, ak47_ammo_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_RIFLE, rifle_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_RIFLE_AMMO, rifle_ammo_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_SNIPERRIFLE, sniperrifle_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_SNIPERRIFLE_AMMO, sniperrifle_ammo_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_RPG, rpg_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_RPG_AMMO, rpg_ammo_final_value);
                WT_TRUCK.vnxSetElementData(EntityData.WEAPON_MOLOTOV, molotov_final_value);
