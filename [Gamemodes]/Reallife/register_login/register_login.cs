    ...
    public class Login : IScript
    {
        ...
        public static void InitializePlayerData(IPlayer player)
        {
            try
            {
                ...
                player.vnxSetElementData(EntityData.PLAYER_SEX, 0);
                player.vnxSetElementData(EntityData.PLAYER_MONEY, 0);
                player.vnxSetElementData(EntityData.PLAYER_BANK, 3500);
                ...
                player.vnxSetElementData(EntityData.PLAYER_AGE, 18);
                ...
                player.vnxSetElementData(EntityData.PLAYER_VIP_LEVEL, "-");
                ...
                player.vnxSetElementData(EntityData.PLAYER_RANK, 0);
                ...
                player.vnxSetElementData(EntityData.PLAYER_PLAYED, 0);
                player.vnxSetElementData(EntityData.PLAYER_STATUS, 0);
                ...
                player.vnxSetStreamSharedElementData(EntityData.PLAYER_STATUS, "VenoX");
                ...
                player.vnxSetElementData(EntityData.PLAYER_TACTIC_KILLS, 0);
                player.vnxSetElementData(EntityData.PLAYER_TACTIC_TODE, 0);

                player.vnxSetElementData(EntityData.PLAYER_REALLIFE_HUD, 0);

                player.vnxSetElementData(EntityData.PLAYER_ZOMBIE_KILLS, 0);
                player.vnxSetElementData(EntityData.PLAYER_ZOMBIE_PLAYERS_KILLED, 0);
                player.vnxSetElementData(EntityData.PLAYER_ZOMBIE_TODE, 0);
        ...
        public static void LoadCharacterData(IPlayer player, PlayerModel character)
        {
            try
            {
                ...
                player.vnxSetElementData(EntityData.PLAYER_SEX, character.sex);

                player.vnxSetElementData(EntityData.PLAYER_SQL_ID, character.id);
                ...
                player.vnxSetElementData(EntityData.PLAYER_AGE, character.age);
                ...
                player.vnxSetElementData(EntityData.PLAYER_RANK, character.rank);
                player.vnxSetElementData(EntityData.PLAYER_ON_DUTY, 0);
                ...
                player.vnxSetElementData(EntityData.PLAYER_PLAYED, character.played);
                player.vnxSetElementData(EntityData.PLAYER_STATUS, character.status);
                ...
                player.vnxSetStreamSharedElementData(EntityData.PLAYER_STATUS, character.SocialState);
                ...
                player.vnxSetStreamSharedElementData("HideHUD", 1);
                player.vnxSetStreamSharedElementData(EntityData.PLAYER_BANK, character.bank);
                player.vnxSetStreamSharedElementData(EntityData.PLAYER_MONEY, character.money);
                player.vnxSetElementData(Verleih.HAVE_PLAYER_RENTED_VEHICLE, 0);

                player.vnxSetElementData(EntityData.PLAYER_TACTIC_KILLS, character.tactic_kills);
                player.vnxSetElementData(EntityData.PLAYER_TACTIC_TODE, character.tactic_tode);
                player.vnxSetElementData(EntityData.PLAYER_REALLIFE_HUD, character.REALLIFE_HUD);


                player.vnxSetElementData(EntityData.PLAYER_ZOMBIE_KILLS, character.zombie_kills);
                player.vnxSetElementData(EntityData.PLAYER_ZOMBIE_PLAYERS_KILLED, character.zombie_player_kills);
                player.vnxSetElementData(EntityData.PLAYER_ZOMBIE_TODE, character.zombie_tode);
            }
            catch { }
        }
        ...
        public static void LoadDatasRemote(IPlayer player)
        {
            try
            {
                if (player.vnxGetElementData<bool>(EntityData.PLAYER_PLAYING) == false)
                {
                    ...
                    player.vnxSetStreamSharedElementData(EntityData.PLAYER_MONEY, player.vnxGetElementData<int>(EntityData.PLAYER_MONEY));
            ...
            try
            {
                ...
                else
                {
                    foreach (IVehicle Vehicle in Alt.GetAllVehicles())
                    {
                        ...
                        {
                            Vehicle.Dimension = 0;
                            Vehicle.vnxSetStreamSharedElementData(EntityData.VEHICLE_DIMENSION, 0);
                        }
                        // JOB 
                        if (
                ...
                if (login == true)
                {
                    ...
                    if (hasDataName)
                    {
                        ...
                        else
                        {
                            ...
                            player.vnxSetElementData(VenoXV.Globals.EntityData.PLAYER_CURRENT_GAMEMODE, VenoXV.Globals.EntityData.GAMEMODE_REALLIFE);
                        }
                        return;
                    }
                    return;
        ...
        public static void ChangeCharacterSexEvent(IPlayer player, int sex)
        {
            try
            {
                ...
                player.vnxSetElementData(EntityData.PLAYER_SEX, sex);
            }
            catch (Exception ex)
            {
