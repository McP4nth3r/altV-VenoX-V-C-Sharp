    ...
    public class Main
    {
        public static List<RoundModel> TacticMaps = new List<RoundModel>
        {
            new RoundModel
            {
                ...
                TeamAWinnerText = "Das S.W.A.T Team gewinnt die Runde.",
                ...
                TeamBWinnerText = "Die Yakuza gewinnt die Runde.",
            ...
            new RoundModel
            {
                ...
                TeamAWinnerText = "Das F.I.B gewinnt die Runde.",
                ...
                TeamBWinnerText = "Die Bloodz gewinnt die Runde.",
            ...
            new RoundModel
            {
                ...
                TeamAWinnerText = "Die Aliens gewinnen die Runde.",
                ...
                TeamBWinnerText = "Die Zombies gewinnen die Runde.",
                TeamBColor = new[] { 200, 0, 0 },
                TeamBSpawnpoints = new List<Vector3>{
            ...
            new RoundModel
            {
                ...
                TeamAWinnerText = "Das SAMCRO gewinnt die Runde.",
                ...
                TeamBWinnerText = "Die Narcos gewinnen die Runde.",
            ...
            new RoundModel
            {
                ...
                TeamAWinnerText = "Das M.W.S.C Team gewinnt die Runde.",
                ...
                TeamBWinnerText = "Das S.W.A.T Team gewinnt die Runde.",
            ...
            new RoundModel
            {
                ...
                TeamAWinnerText = "Die US-Army gewinnt die Runde.",
                ...
                TeamBWinnerText = "Das Terroristen Team gewinnt die Runde.",
            ...
            new RoundModel
            {
                ...
                TeamAWinnerText = "Die Yakuza gewinnt die Runde.",
                ...
                TeamBWinnerText = "Die Vagos gewinnt die Runde.",
            ...
            new RoundModel
            {
                ...
                TeamAWinnerText = "Die Penner[1] gewinnen die Runde.",
                TeamAColor = new[] { 125, 0, 0 },
                TeamASpawnpoints = new List<Vector3>{
                ...
                TeamBWinnerText = "Die Penner[2] gewinnen die Runde.",
            ...
            new RoundModel
            {
                ...
                TeamAWinnerText = "Die Bio Menschen gewinnen die Runde.",
                TeamAColor = new[] { 125, 0, 0 },
                TeamASpawnpoints = new List<Vector3>{
                ...
                TeamBWinnerText = "Die Compton Family gewinnen die Runde.",
                TeamBColor = new[] { 0, 200, 0 },
                TeamBSpawnpoints = new List<Vector3>{
            ...
            {
                MapName = "Baustelle",
                TeamAName = "Bauarbeiter",
                TeamASkin = "s_m_y_construct_02",
                TeamAWinnerText = "Die Bauarbeiter gewinnen die Runde.",
                ...
                TeamBWinnerText = "Die Ballas gewinnen die Runde.",
            ...
            {
                MapName = "Gefängnis",
                TeamAName = "Inhaftierte",
                TeamASkin = "s_m_y_prisoner_01",
                TeamAWinnerText = "Die Inhaftierten gewinnen die Runde.",
                TeamAColor = new[] { 255, 255, 0 },
                TeamASpawnpoints = new List<Vector3>{
                ...
                TeamBWinnerText = "Die Wärter gewinnen die Runde.",
            ...
            new RoundModel
            {
                ...
                TeamAName = "SAMCRO",
                TeamASkin = "g_m_y_lost_03",
                TeamAWinnerText = "SAMCRO gewinnt die Runde.",
                TeamAColor = new[] { 100, 50, 50 },
                TeamASpawnpoints = new List<Vector3>{
                ...
                TeamBWinnerText = "Der MayansMC gewinnt die Runde.",
            ...
            new RoundModel
            {
                MapName = "Altruistendorf",
                TeamAName = "Altruisten",
                TeamASkin = "a_m_o_acult_01",
                TeamAWinnerText = "Die Altruisten gewinnen die Runde.",
                TeamAColor = new[] { 100, 50, 50 },
                TeamASpawnpoints = new List<Vector3>{
                ...
                TeamBWinnerText = "Merryweather gewinnt die Runde.",
            ...
            {
                MapName = "Holzfäller",
                TeamAName = "Holzfäller",
                TeamASkin = "s_m_y_construct_01",
                TeamAWinnerText = "Die Holzfäller gewinnen die Runde.",
                ...
                TeamBWinnerText = "SAMCRO gewinnt die Runde.",
            ...
            new RoundModel
            {
                ...
                TeamAName = "S.W.A.T",
                TeamASkin = "s_m_y_swat_01",
                TeamAWinnerText = "Das S.W.A.T gewinnt die Runde.",
                TeamAColor = new[] { 0, 50, 183 },
                TeamASpawnpoints = new List<Vector3>{
            ...
            new RoundModel
            {
                ...
                TeamAName = "Militär",
                TeamASkin = "s_m_y_marine_03",
                TeamAWinnerText = "Das Militär gewinnt die Runde.",
                TeamAColor = new[] { 0, 50, 183 },
                TeamASpawnpoints = new List<Vector3>{
            ...
            new RoundModel
            {
                ...
                TeamAWinnerText = "Die Angler gewinnen die Runde.",
                ...
                TeamBWinnerText = "Das P.B.P.D gewinnen die Runde.",
