...
using VenoX.Debug;
using Main = VenoX.Core._Gamemodes_.Reallife.globals.Main;

namespace VenoX.Core._Gamemodes_.Zombie.Assets
{
    public class ZombieAssets
    {
        private static void LoadZombieClothesByIndex(VnXPlayer player, int index)
        {
            try
            {
                ...
                */
                _RootCore_.VenoX.TriggerPreloadEvent(player, "Zombie Clothes [" + index + "]", "Zombies:LoadEntityClassClothes", index,
        ...
        private static void LoadZombieAccessoriesByIndex(VnXPlayer player, int index)
        {
            try
            {
                ...
                Core.Debug.OutputDebugString("ID10 : " + Slot10Drawable + " | " + Slot10Texture);
                Core.Debug.OutputDebugString("ID11 : " + Slot11Drawable + " | " + Slot11Texture);*/
                _RootCore_.VenoX.TriggerPreloadEvent(player, "Zombie Accessories [" + index + "]", "Zombies:LoadEntityClassAccessories", index,
                    slot1Drawable, slot1Texture,
                    slot2Drawable, slot2Texture,
                    slot3Drawable, slot3Texture,
                    slot4Drawable, slot4Texture,
        ...
        public static void LoadZombieEntityData(VnXPlayer player)
        {
            try
            {
                ...
                {
                    i++;
                    _RootCore_.VenoX.TriggerPreloadEvent(player, "Zombie Skins [" + i + "/" + _Preload_.Character_Creator.Main.CharacterSkins.ToList().Count + "]", "Zombies:LoadEntityClass", entityClass.Uid, entityClass.FaceFeatures, entityClass.HeadBlendData, entityClass.HeadOverlays);
