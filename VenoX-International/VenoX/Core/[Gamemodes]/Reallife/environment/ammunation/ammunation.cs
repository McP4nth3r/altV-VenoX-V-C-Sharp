...
namespace VenoX.Core._Gamemodes_.Reallife.environment.ammunation
{
    public class Ammunation : IScript
    {
                    ...
                    case "Pistolen Magazin":
                        {
                            ...
                            if (pistole != null)
                            {
                                ...
                                {
                                    player.SendTranslatedChatMessage(RageApi.GetHexColorcode(200, 0, 0) + "You don't have enough money!");
                                }
                            }
                            else
                            {
        ...
        public static bool OnPlayerEnterColShapeModel(ColShapeModel shape, VnXPlayer player)
        {
            try
            {
                ...
                _RootCore_.VenoX.TriggerClientEvent(player, "Ammunation:Show");
                return true;
