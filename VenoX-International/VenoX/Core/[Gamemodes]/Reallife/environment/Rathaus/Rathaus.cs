...
using VenoX.Core._Gamemodes_.Reallife.environment.Rathaus.LKWschein;
using VenoX.Core._Gamemodes_.Reallife.environment.Rathaus.Motorradschein;
...
namespace VenoX.Core._Gamemodes_.Reallife.environment.Rathaus
{
    public class Rathaus : IScript
    {
        ...
        public static bool OnPlayerEnterColShapeModel(ColShapeModel shape, VnXPlayer player)
        {
            try
            {
                ...
                Task.Run(async () =>
                {
                    string price = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Preis:");
                    string persoBtn = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Personalausweis");
                    string carBtn = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Führerschein");
                    string lkwBtn = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "LKW-Führerschein");
                    string bikeBtn = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Motorradschein");
                    string planeABtn = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Flugschein A");
                    string planeBBtn = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Flugschein B");
                    string helicopterBtn = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Helikopterschein");
                    string boatBtn = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Bootsschein");
                    string fisherBtn = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Angelschein");
                    string weaponBtn = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Waffenschein");

                    string persoAsset = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Der Personalausweis ist das");
                    string persoAsset1 = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "wichtigste was du bei dir");
                    string persoAsset2 = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "haben kannst, mit diesem");
                    string persoAsset3 = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "Identifizierst du dich");
                    string persoAsset4 = await global::VenoX.Core._Language_.Main.GetTranslatedTextAsync((global::VenoX.Core._Language_.Constants.Languages)player.Language, "bei den Behörden.");
                    ...
                    _RootCore_.VenoX.TriggerClientEvent(player, "showRathausWindow", "Stadthalle", persoBtn, carBtn, lkwBtn, bikeBtn, planeABtn, planeBBtn, helicopterBtn, boatBtn, fisherBtn, weaponBtn, perso, fuehrer, lkw, bike, fa, fb, heli, boot, angel, waffen);
            ...
            try
            {
                switch (button)
                {
                    case "Perso":
                        ...
                        {
                            _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Error, "Du hast bereits einen Personalausweis!");
                            return;
                        }
                        ...
                        _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Info, "[Rathaus] : Personalausweis erhalten!");
                        break;
                    case "Auto":
                    ...
                    case "Plane_A":
                        ...
                        {
                            _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Error, "Du hast bereits einen Flugschein A!");
                            return;
                        }
                        ...
                        _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Info, "[Rathaus] : Flugschein A erhalten!");
                        break;
                    case "Plane_B":

                        if (player.Reallife.FlyLicenseB != 1)
                        {
                            _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Error, "Du brauchst zuerst einen Flugschein A!");
                            return;
                        }
                        if (player.Reallife.FlyLicenseB == 1)
                        {
                            _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Error, "Du hast bereits einen Flugschein B!");
                            return;
                        }
                        ...
                        _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Info, "[Rathaus] : Flugschein B erhalten!");
                        break;
                    case "Heli":
                        if (player.Reallife.HelicopterDrivingLicense == 1)
                        {
                            _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Error, "Du hast bereits einen Helikopterschein!");
                            return;
                        }
                        ...
                        _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Info, "[Rathaus] : Helikopterschein erhalten!");
                        break;
                    case "Boat":
                        if (player.Reallife.MotorBoatDrivingLicense == 1)
                        {
                            _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Error, "Du hast bereits einen Bootsschein!");
                            return;
                        }
                        ...
                        _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Info, "[Rathaus] : Bootsschein erhalten!");
                        break;
                    case "Fisher":

                        if (player.Reallife.FishingLicense == 1)
                        {
                            _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Error, "Du hast bereits einen Angelschein!");
                            return;
                        }
                        ...
                        _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Info, "[Rathaus] : Angelschein erhalten!");
                        break;
                    case "Weapon":
                        if (player.Reallife.WeaponLicense == 1)
                        {
                            ...
                            _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Error, "Du hast bereits einen Waffenschein!");
                            return;
                        }
                        ...
                        if (player.PlayTime < 3 * 60)
                        {
                            _Globals_.Notification.DrawNotification(player, _Globals_.Notification.Types.Error, "Erst ab 3 Spielstunden möglich.");
                            return;
                        }
                        ...
                        if (vehClass.Reallife.DrivingSchoolVehicle)
                        {
                            switch (vehClass.Reallife.DrivingSchoolLicense)
                            {
                                case DrivingschoolLicenseCar:
                                    ...
                                    ConsoleHandling.OutputDebugString("Called Car Hit Marker");
                                    break;
                                case DrivingschoolLicenseBike:
                                    MotorradFührerschein.OnPlayerEnterColShapeModel(shape, player);
                                    ConsoleHandling.OutputDebugString("Called Bike Hit Marker");
                                    break;
                                case DrivingschoolLicenseLkw:
                                    LkwFührerschein.OnPlayerEnterColShapeModel(shape, player);
                                    ConsoleHandling.OutputDebugString("Called LKW Hit Marker");
                                    break;
                                default:
                                    ConsoleHandling.OutputDebugString("Called " + vehClass.Reallife.DrivingSchoolLicense);
                                    break;
                            }
                        }
                        return true;
        ...
        public static VehicleModel CreateDrivingSchoolVehicle(VnXPlayer player, AltV.Net.Enums.VehicleModel veh, Vector3 position, Vector3 rotation, int dimension = (_Globals_.Initialize.ReallifeDimension), bool warpIntoVehicle = true)
        {
            try
            {
                ...
                drivingSchoolVehicle.Owner = player.CharacterUsername;
