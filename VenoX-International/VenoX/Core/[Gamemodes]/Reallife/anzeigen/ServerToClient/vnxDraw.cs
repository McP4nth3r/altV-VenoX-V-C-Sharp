...
namespace VenoX.Core._Gamemodes_.Reallife.anzeigen.ServerToClient
{
    public class VnX : IScript
    {
        ...
        public static void DestroyWindow(VnXPlayer player, string window)
        {
            ...
            {
                case "Job1":
                    _RootCore_.VenoX.TriggerClientEvent(player, "DestroyJobWindow1");
                    break;
                case "Window":
                    _RootCore_.VenoX.TriggerClientEvent(player, "DestroyVnXSAWindowLib");
                    break;
                case "WindowSelection":
                    _RootCore_.VenoX.TriggerClientEvent(player, "DestroyVnXSAWindowSel");
                    break;
                case WindowInput:
                    _RootCore_.VenoX.TriggerClientEvent(player, "DestroyInputWindow");
                    break;
                default:
                    _RootCore_.VenoX.TriggerClientEvent(player, window);
                    break;
            }
        }
        ...
        public static void DestroyRadarElement(VnXPlayer player, string element)
        {
            ...
            {
                case "Blip":
                    _RootCore_.VenoX.TriggerClientEvent(player, "deleteBlipWaypoint");
                    break;
                case "Blip_lib":
                    _RootCore_.VenoX.TriggerClientEvent(player, "deleteBlip_lib");
                    break;
                default:
        ...
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "Job:ShowAcceptWindow", headertext, boxtext, buttontext1, buttontext2);
        }
        ...
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "Job:ShowSelection1", headertext, boxtext, buttontext1, buttontext2, buttontext3, button1desc, button2desc, button3desc, joblvlinfo);
        }
        ...
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "createVnXSAWindowSelection", headertext, boxtext, buttontext1, buttontext2);
        }

        public static void DrawBlip(VnXPlayer player, string name, Position position, int blipId, int blipRgba, int dimension)
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "placeBlip", name, position, blipId, blipRgba, dimension);
        }

        public static void DrawZielBlip(VnXPlayer player, string name, Position position, int blipId, int blipRgba, int dimension)
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "placeBlipWaypoint", name, position, blipId, blipRgba, dimension);
        }
        ...
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "placeCustomBlipWaypoint", name, position, scale, blipId, blipRgba, dimension, r, g, b, a);
        }
        ...
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "placeBlipWaypoint_Table", tableName, name, position, blipId, blipRgba, dimension, destroyedinms);
        }
        public static void DrawWaypoint(VnXPlayer player, float x, float y)
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "VnXSetWaypoint", x, y);
        }

        public static void DrawInputWindow(VnXPlayer player, string headertext, string boxtext, string buttontext)
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "createInputWindow", headertext, boxtext, buttontext);
        }

        public static void SetElementFrozen(VnXPlayer player, bool state)
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "Player:Freeze", state);
        }
        public static void SetDelayedIVehicleElementFrozen(VehicleModel vehicle, VnXPlayer sender, bool state, int timeInMs)
        {
            if (vehicle != null)
            {
                _RootCore_.VenoX.TriggerClientEvent(sender, "FreezeVEHICLE_DelayedPLAYER_VnX", vehicle, state, timeInMs);
            }
        }
        public static void CreateDiscordUpdate(VnXPlayer player, string top, string main)
        {
            _RootCore_.VenoX.TriggerClientEvent(player, "discord_update", top, main);
        }
    }
}
