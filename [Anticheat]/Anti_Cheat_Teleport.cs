...
namespace VenoXV.Anti_Cheat
{
    public class Anti_Cheat_Teleport : IScript
    {
        ...
        public static void Ban_Player_TeleportCheat(PlayerModel player)
        {
            try
            {
                if (player.Health != 0)
        ...
        public static void Ban_Player_SpeedCheat(PlayerModel player, int distanz, string position_now, string position_last)
        {
            try
            {
                if (player.Health != 0)
                {
                    ...
                    logfile.WriteAntiCheatLogs("speed", "[ANTI-CHEAT][0x005] : " + player.GetVnXName() + " | Distanz : " + distanz + " | Position Now : " + position_now + " | Position Last : " + position_last);
                }
            }
            catch { }
        }
