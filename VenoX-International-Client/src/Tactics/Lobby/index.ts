...
alt.onServer('LoadTacticUI', (A_Name, B_Name, r, g, b, r1, g1, b1) => {
    if (alt.Player.local.getStreamSyncedMeta('RAGEAPI:SpawnedPlayer')) game.freezeEntityPosition(alt.Player.local.scriptID, false);
...
function TacticsEveryTick() {
    ...
    game.drawRect(0.846, 0.3, 0.06, 0.035, 0, 0, 0, 175, false);
    game.drawRect(0.9105, 0.3, 0.06, 0.035, 0, 0, 0, 175, false);
    game.drawRect(0.975, 0.3, 0.06, 0.035, 0, 0, 0, 175, false);

    game.drawRect(0.916, 0.2818, 0.2, 0.003, 0, 150, 200, 175, false);
    ...
    game.drawSprite('mpinventory', 'deathmatch', 0.826, 0.3, 0.025, 0.025, 0, 255, 255, 255, 255, false);
    DrawText(Current_Kills + ' KILLS', [0.85, 0.289], [0.35, 0.33], 4, [225, 225, 225, 255], true, true);
    game.drawSprite('mpinventory', 'mp_specitem_weapons', 0.8935, 0.3, 0.0215, 0.0215, 0, 255, 255, 255, 255, false);
