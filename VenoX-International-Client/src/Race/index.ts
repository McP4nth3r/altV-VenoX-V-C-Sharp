...
import { DrawText, GetCurrentDateTime, ShowCountdown } from '../Globals/VnX-Lib';
...
alt.onServer('Race:Load', () => {
    ...
    RaceTimer = alt.everyTick(() => {
        try {
            ...
            game.drawRect(0.93, 0.5, 0.1, 0.3, 0, 0, 0, 200, false);
            game.drawRect(0.93, 0.365, 0.1, 0.03, 0, 0, 0, 180, false);
            game.drawRect(0.93, 0.349, 0.1, 0.003, 0, 150, 200, 255, false);

            DrawText('Race-Info', [0.93, 0.35], [0.5, 0.5], 1, [255, 255, 255, 255], true, true);
            ...
            if (game.hasStreamedTextureDictLoaded('hunting')) {
                game.drawSprite('hunting', 'hunting_gold_128', 0.89, 0.39, 0.015, 0.015, 0, 255, 255, 255, 255, false);
                game.drawSprite('hunting', 'hunting_silver_128', 0.89, 0.415, 0.015, 0.015, 0, 255, 255, 255, 255, false);
                game.drawSprite('hunting', 'hunting_bronze_128', 0.89, 0.443, 0.015, 0.015, 0, 255, 255, 255, 255, false);
            }
            let counter = 0;
